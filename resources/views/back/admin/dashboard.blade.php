                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-1">
                            <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">
                                Vote Count</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $voteCount }}</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-1">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <a href="{{ route('admin.article.edit', $mostVotedTodayArticleId) }}">
                                    {{ $mostVotedTodayArticleName . ' (' . $mostVotedTodayVoteCount . ')' }}
                            </div>
                            </a>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
                            ...
                            @foreach ($lastTenArticle as $row)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.article.edit', $row->id) }}" title="Edit"
                                            class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.delete.article', $row->id) }}" title="Delete"
        ...
        <div class="col-xl-12 col-lg-7">
            <div class="card shadow mb-4">
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Last 10 Users</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
