...
class ArticleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("back.admin.articles.index", compact('articles'));
    }
    ...
    {
        return view("back.admin.articles.create");
    }
    ...
    public function edit($id)
    {
        ...
        return view("back.admin.articles.edit", compact('article'));
    }
    ...
    public function trash()
    {
        ...
        return view("back.admin.articles.trash", compact('articles'));
    }
